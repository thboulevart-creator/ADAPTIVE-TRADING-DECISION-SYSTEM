...
OUT = Path("trading_breaks_batch05_artifacts")
...
async def main() -> int:
    ...
    # Batch 05 execution identity comes only from the historically frozen tuple.
    ...
    if len(targets) != BATCH_SIZE:
        raise RuntimeError("FROZEN_BATCH05_SIZE_DRIFT")
