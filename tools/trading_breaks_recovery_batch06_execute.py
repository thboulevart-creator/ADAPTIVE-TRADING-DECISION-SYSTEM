...
OUT = Path("trading_breaks_batch06_artifacts")
...
async def main() -> int:
    ...
    # Batch 06 execution identity comes only from the historically frozen tuple.
    ...
    if len(targets) != BATCH_SIZE:
        raise RuntimeError("FROZEN_BATCH06_SIZE_DRIFT")
