...
OUT = Path("trading_breaks_batch07_artifacts")
...
async def main() -> int:
    ...
    # Batch 07 execution identity comes only from the historically frozen tuple.
    ...
    if len(targets) != BATCH_SIZE:
        raise RuntimeError("FROZEN_BATCH07_SIZE_DRIFT")
