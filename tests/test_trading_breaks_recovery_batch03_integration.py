...
def test_batch03_integrated_evidence_remains_valid_in_post_batch07_state():
    ...
    assert global_report["resolved_candidate_dates"] == 49
    assert global_report["unresolved_candidate_dates"] == 62
    ...
    assert window_report["resolved_candidate_dates"] == 26
    assert window_report["unresolved_candidate_dates"] == 42


def test_batch03_attempt_history_remains_preserved_post_batch07():
