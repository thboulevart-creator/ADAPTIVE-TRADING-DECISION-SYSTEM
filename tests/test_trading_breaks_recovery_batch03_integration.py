...
def test_batch03_integrated_evidence_remains_valid_in_post_batch06_state():
    ...
    assert global_report["resolved_candidate_dates"] == 46
    assert global_report["unresolved_candidate_dates"] == 65
    ...
    assert window_report["resolved_candidate_dates"] == 23
    assert window_report["unresolved_candidate_dates"] == 45


def test_batch03_attempt_history_remains_preserved_post_batch06():
