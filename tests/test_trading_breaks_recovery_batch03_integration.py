...
def test_batch03_integrated_evidence_remains_valid_in_post_batch13_state():
    ...
    assert global_report["resolved_candidate_dates"] == 72
    assert global_report["unresolved_candidate_dates"] == 39
    ...
    assert window_report["resolved_candidate_dates"] == 49
    assert window_report["unresolved_candidate_dates"] == 19
