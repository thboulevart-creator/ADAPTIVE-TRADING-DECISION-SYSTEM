...
def test_batch03_integrated_evidence_remains_valid_in_post_batch12_state():
    ...
    assert global_report["resolved_candidate_dates"] == 69
    assert global_report["unresolved_candidate_dates"] == 42
    ...
    assert window_report["resolved_candidate_dates"] == 46
    assert window_report["unresolved_candidate_dates"] == 22
