...
def test_batch03_integrated_evidence_remains_valid_in_post_batch10_state():
    ...
    assert global_report["resolved_candidate_dates"] == 60
    assert global_report["unresolved_candidate_dates"] == 51
    ...
    assert window_report["resolved_candidate_dates"] == 37
    assert window_report["unresolved_candidate_dates"] == 31
